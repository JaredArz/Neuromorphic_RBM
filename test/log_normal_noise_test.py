...
sys.path.append('../')
import SA_funcs as f
import RRAM_types as r
...
def main():
    # ======================
    y_select = "log10_R"  #R,log10 R,G
    plot_select = "cdf"    #hist, cdf
    # ======================
    G_LRS = 1.0/1e5
    std_dev = 0.375
    ...
    for i in range(sample_num):
        G_w_noise = f.inject_add_cyc_noise(G_LRS_mat,cbarr, std_dev)
